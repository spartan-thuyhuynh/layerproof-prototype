...
export const RECENT_PROJECTS: RecentProject[] = [
  {
    ...
    type: 'Social Post',
    typeColor: '#f97316',
    thumbBg: 'linear-gradient(135deg, #f9731622 0%, #f9731644 100%)',
    thumbIcon: 'Social',
    thumbIconColor: '#f97316',
  ...
  },
  {
    ...
    type: 'Social Post',
    typeColor: '#f97316',
    thumbBg: 'linear-gradient(135deg, #f9731618 0%, #f9731638 100%)',
    thumbIcon: 'Social',
    thumbIconColor: '#f97316',
  ...
  },
  {
    ...
    type: 'Presentation',
    typeColor: '#8b5cf6',
    thumbBg: 'linear-gradient(135deg, #1a1230 0%, #2d1b69 100%)',
    thumbIcon: 'Present',
  ...
  },
  {
    ...
    type: 'Docs',
    typeColor: '#14b8a6',
    thumbBg: 'linear-gradient(135deg, #0d3d3a 0%, #134e4a 100%)',
    thumbIcon: 'Docs',
